  ...
  return (
    <div className="home-snap-container">
      ...
      <section className="snap-section module-section" id="navigatemenu" ref={navigatemenu}>
        ...
        <p className="hide-on-mobile">Розмовляй із собою, як з тим, кого любиш.</p>
      </section>

      {/* МОДУЛІ */}
      <section className="snap-section mood-section" ref={moodRef}>
      ...
      <section className="snap-section meditation-section" ref={meditationsRef}>
